...
## Pré-Requisitos
Para instalar as dependências do projeto e executar os testes automatizados, é necessário que o [Node.js](https://nodejs.org/en/) e o [NPM](https://www.npmjs.com/) estejam instalados em seu computador.
